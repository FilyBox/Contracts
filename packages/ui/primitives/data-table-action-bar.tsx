    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className={cn(
            'bg-background text-foreground z-9999 fixed inset-x-0 bottom-6 mx-auto flex w-fit flex-wrap items-center justify-center gap-2 rounded-md border p-2 shadow-sm',
            className,
          )}
          {...props}
        >
...
function DataTableActionBarSelection<TData>({ table }: DataTableActionBarSelectionProps<TData>) {
  ...
  return (
    <div className="flex h-7 items-center rounded-md border pl-2.5 pr-1">
