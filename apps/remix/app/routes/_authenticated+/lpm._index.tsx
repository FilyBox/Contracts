...
// // Define the LpmItem type based on the structure of items in data.music
// type LpmItem = {
...
//   trackName?: string;
//   // Add any other fields present in the items of data.music
//   [key: string]: any;
// };
...
//         ) : (
//           <LpmTable
//             lpm={(data?.music || []).map((item: LpmItem) => ({
//               ...item,
